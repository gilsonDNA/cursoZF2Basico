 ...
 */
class Livro extends \Livraria\Entity\Livro implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nome', 'categoria', 'autor', 'isbn', 'valor');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Livro $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCategoria(\Livraria\Entity\Categoria $categoria)
    {
